...
<head>
    ...
    <script>
        ...
        function page(num){
            ...
            location = "user?m=list&currentPage="+num+"&mohu="+mohu;
        }
    </script>
</head>
<body>
<%--<input type="button" value="stop" id="stop">--%>
    ...
    <form id="f" action="user" method="get">
